<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
			   ...
			   <div class="navbar-header " >
				...
				<div class="collapse navbar-collapse "   id="mynavbar">
					<div class="nav navbar-nav navbar-right note " >
						...
						<li class=" head menu"> <a href="services.php" class="active">Services </a> </li>
	...
	<div style="position:relative; font-family: Arial;" >
	  <img src="images/sheader2.jpg" alt="trek" style="width:100%;">
	...
	<div class="container">
		...
		<div  align="center"> 
		<h3 style="text-align:center; color:#044E80; "><strong>Explore our services </strong></h3>
		<p style="font-family:arial; color:#e9165b;"> Far far away, behind the word mountians far from the countries Vokalia and Consonantia, there lives blind text. </p>
		</div> <br>
		<hr>
	</div>
	...
	<div class="container">
		<div class="row" align="center">
			...
			<img src="images/s01.jpg" />
				<h3 style="font-family:roboto-bold;"> CONSULT WITH AN EXPERT </h3>
				<p style="font-family:arial;"> We will match you with an expert on your destination from our team of widely travel experts who travel the globe and understand your expectations.</p>
			</div>
			<div class="col-md-4">
			<img src="images/s02.jpg" />
				<h3 style="font-family:roboto-bold;">GET A CUSTOMIZED PLAN </h3>
				<p> Our expert will map out entire trip, with insider recommendations about where to go, what to do, how to get around and where to stay.</p>
			</div>
			<div class="col-md-4">
			<img src="images/s03.jpg" />
				<h3 style="font-family:roboto-bold;"> BOOK YOUR TRIP</h3>
				<p>Finally, our in-house specialists will help you book the trips or activities on your vacation plans at the best available rates. </p>
			</div>
		</div>
	</div>
<!-- services starts-->
