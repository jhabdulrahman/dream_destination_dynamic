			   ...
			   <div class="navbar-header " >
				...
				<div class="collapse navbar-collapse "   id="mynavbar">
					<div class="nav navbar-nav navbar-right note " >
						...
						<li class="head menu"> <a href="portfolio.php" class="active">portfolio </a> </li>
...
<header>
				<h2 style="text-align:center; color:#044E80; "><strong> Portfolio </strong></h2>
            </header>
<div class="freshdesignweb" style="margin-top: 50px; margin-left: 20px;">     
<!-- Portfolio 4 Column start -->
    ...
    <ul style="height: 495px;" id="list" class="portfolio_list da-thumbs"><li>
            <img src="images1/portfolio1.jpg" alt="img">
            <article class="da-animate da-slideFromRight" style="display: block;">
                <h3>New Year 2013</h3>
                <em>Happy</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
                <span class="zoom"><a href="images/portfolio1.jpg"></a></span>
            </article>
        </li><li>
            <img src="images1/portfolio2.jpg" alt="img">
            ...
            <img src="images1/portfolio3.jpg" alt="img">
            ...
            <img src="images1/portfolio4.jpg" alt="img">
            <article class="da-animate da-slideFromRight" style="display: block;">
                <h3>Fashion</h3>
                <em>China</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
            ...
            <img src="images1/portfolio5.jpg" alt="img">
            <article class="da-animate da-slideFromRight" style="display: block;">
                <h3>Asean life</h3>
                <em>lobortis</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
            ...
            <img src="images1/portfolio6.jpg" alt="img">
            <article class="da-animate da-slideFromRight" style="display: block;"> 
                <h3>Asean life</h3>
                <em>elementum</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
            ...
            <img src="images1/portfolio7.jpg" alt="img">
            <article class="da-animate da-slideFromRight" style="display: block;">
                <h3>Asean life</h3>
                <em>risus</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
            ...
            <img src="images1/portfolio8.jpg" alt="img">
            <article class="da-animate da-slideFromLeft" style="display: block;">
                <h3>Asean life</h3>
                <em>arcu</em>
                <span class="link_post"><a href="http://www.freshdesignweb.com/responsive-portfolio-gallery-with-jquery-tutorial.php"></a></span>
